        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(auth()->user()->role == 'admin')
                        <!-- MENU KHUSUS ADMIN -->
                        <x-nav-link href="/lokasi-parkir" :active="request()->is('lokasi-parkir*')">
                            Kelola Lokasi Parkir
                        </x-nav-link>
                        <x-nav-link href="/penugasan" :active="request()->is('penugasan*')">
                            Penugasan Jukir
                        </x-nav-link>
                    ...
                    @elseif(auth()->user()->role == 'jukir')
                        <!-- MENU KHUSUS JUKIR -->
                        <x-nav-link href="/jadwal-jukir" :active="request()->is('jadwal-jukir*')">
                            Jadwal & Lokasi Saya
                        </x-nav-link>

                    @else
                        <!-- MENU KHUSUS WARGA / USER -->
                        <x-nav-link href="/warga/dashboard" :active="request()->is('warga/dashboard')">
                            Status Bebas Parkir
                        </x-nav-link>
                        <x-nav-link href="/laporan" :active="request()->is('laporan*')">
                            Daftar Laporan
